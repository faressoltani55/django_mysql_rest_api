    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='v_mysql.student')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='v_mysql.subject')),
            ],
        ),
        migrations.CreateModel(
            name='Class',
